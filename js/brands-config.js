...
// Each language's own name, in that language — shown in the header's
// language dropdown instead of an abbreviation ("Português", not "PT"),
// since a native reader recognizes the actual name faster than a code.
