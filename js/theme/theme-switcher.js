// Multi-brand support: only needed for a build serving several white-label
// brands with a live brand selector. See README "Single-brand build" for
// the removal steps if forking for a single fixed brand.
